...
//            }
//            else {
//                  JOptionPane.showMessageDialog(null, "Registration for updated age is full. Hence update failed!","Warning",JOptionPane.ERROR_MESSAGE);
//             
...
//            }
    ...
    public void fillImmunizationRecords(Student s){
        ...
        for(Object immun : immunizations){
            ...
            //System.out.println(i.getImmunId());
